...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to vecod "gobject list" output
    ...
    def vecod_serialise(self):
        import vecolib
        return vecolib.SHIM_serialise_for_vecod(self.serialise())
