...
sentinel_cfg = VecoConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_vecod_proto_version_with_sentinel_ping = 70207


def get_veco_conf():
    home = os.environ.get('HOME')

    veco_conf = os.path.join(home, ".vecocore/veco.conf")
    if sys.platform == 'darwin':
        veco_conf = os.path.join(home, "Library/Application Support/VecoCore/veco.conf")

    veco_conf = sentinel_cfg.get('veco_conf', veco_conf)
